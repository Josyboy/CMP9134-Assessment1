              ...
              telemetry.sensors.lidar.length === 0 ? (
                ...
                <>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg">
                      <p className="text-gray-600 text-sm">Closest Object</p>
                      <p
                    ...
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg">
                      <p className="text-gray-600 text-sm">Furthest Reading</p>
                    ...
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg">
                      <p className="text-gray-600 text-sm">Average Range</p>
                    ...
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg">
                      <p className="text-gray-600 text-sm">Scan Points</p>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg text-center">
                      <p className="text-gray-600 text-sm mb-1">Front (0°)</p>
                      <p
                    ...
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg text-center">
                      <p className="text-gray-600 text-sm mb-1">Right (90°)</p>
                      <p
                    ...
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg text-center">
                      <p className="text-gray-600 text-sm mb-1">Back (180°)</p>
                      <p
                    ...
                    <div className="bg-white shadow-shadow1 p-4 rounded-lg text-center">
                      <p className="text-gray-600 text-sm mb-1">Left (270°)</p>
                      <p
